...
%%%%%%%%%%%%%%%%%%
%%
%%N�mero de amostras da Classe 1
class1 = samples1;
...
%%
%%N�mero de amostras da Classe 2
% class2 = samples2;
% 
...
%%
% %%N�mero de amostras da Classe 3
% class3 = 122;
% %%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%
% %%N�mero de amostras da Classe 4
% class4 = 151;
% %%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%
%%Cabe�alho do arquivo (pronto para ser convertido para ARFF)
header = cell(368,1);
